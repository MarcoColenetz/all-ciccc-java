...
if(mattScore >= limitScore){

  if(simonScore >= limitScore){
    console.log("Both students have passed the exam")


  }
  else {
    console.log("Matt has passed the exam, Matt's score is: "+ mattScore)

  }
}
else if(simonScore >= limitScore){
   console.log("Simon has passed the exam, Simon's score is: "+ simonScore)
